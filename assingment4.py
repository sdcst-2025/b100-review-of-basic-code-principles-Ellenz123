...
initial_debt=float(input("Enter initial debt amount:$ "))
monthly_interest_rate=float(input("Enter the monthly interest rate in %: "))
...
if debt <=0:
    print(f"It will take {months} months to repay the debt.")
